class Sentry_ProjectileExplosion extends Doom_Emitter;
...
defaultproperties
{
     Begin Object Class=SpriteEmitter Name=SpriteEmitter0
         ...
         StartSizeRange=(X=(Min=2.000000,Max=3.000000),Y=(Min=60.000000,Max=80.000000),Z=(Min=60.000000,Max=80.000000))
         InitialParticlesPerSecond=10.000000
         Texture=Texture'tK_DoomMonsterPackv3.FlashStrips.Doom_Flash_Strip'
         TextureUSubdivisions=32
         TextureVSubdivisions=1
         SecondsBeforeInactive=0.000000
         LifetimeRange=(Min=0.600000,Max=0.800000)
     End Object
     Emitters(0)=SpriteEmitter'tK_DoomMonsterPackv3.Sentry_ProjectileExplosion.SpriteEmitter0'
     ...
     End Object
     Emitters(1)=SpriteEmitter'tK_DoomMonsterPackv3.Sentry_ProjectileExplosion.SpriteEmitter1'
